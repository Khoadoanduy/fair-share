...
import { View, Text, StyleSheet, SafeAreaView, ScrollView, Image, Pressable, Alert, TextInput, Modal } from 'react-native';
...
export default function SubscriptionDetailsScreen() {
    ...
    const handleToggleEdit = async () => {
        if (userRole !== 'leader') {
            Alert.alert('Permission Denied', 'Only group leaders can edit credentials');
            return;
        }
        ...
        if (isEditing) {
            ...
            try {
                ...
                const response = await axios.get(`${API_URL}/api/group/${groupId}/subscription-details`);
                ...
                if (axios.isAxiosError(error) && error.response?.status === 403) {
                    Alert.alert('Permission Denied', 'Only group leaders can update credentials');
                } else {
        ...
        <SafeAreaView style={styles.container}>
            <ScrollView style={styles.content}>
                ...
                <View style={styles.header}>
                    ...
                    {/* Only show edit icon for leaders - using edit-outline icon */}
                    {userRole === 'leader' && (
                        <Pressable onPress={() => setIsEditing(!isEditing)}>
                            <Ionicons name="create-outline" size={24} color="#4A3DE3" />
                        </Pressable>
                    )}
                    {userRole !== 'leader' && <View style={{ width: 24 }} />}
                </View>
                    ...
                    {isEditing ? (
                        ...
                        <View style={styles.editingCredentialsContainer}>
                            <View style={styles.editingHeader}>
                                <Text style={styles.editingSectionTitle}>Account credentials</Text>
                            ...
                            <View style={styles.editingCredentialsBox}>
                                <View style={styles.editingCredentialItem}>
                                    ...
                                    <View style={styles.editingCredentialInfo}>
                                        <Text style={styles.editingCredentialLabel}>Username/Email</Text>
                                        <TextInput
                        ...
                        <View style={styles.subscriptionDetailsBox}>
                            ...
                            <View style={styles.detailRow}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.detailSubtext}>To be handled by another person</Text>
                                </View>
                            </View>
...
const styles = StyleSheet.create({
    ...
    retryButton: { backgroundColor: '#4A3DE3', padding: 12, borderRadius: 8, marginTop: 16 },
    ...
    subscriptionCard: { alignItems: 'center', paddingVertical: 32, marginHorizontal: 20, marginBottom: 24, borderRadius: 16, backgroundColor: '#FAFAFA' },
    logo: { width: 60, height: 60, borderRadius: 30, marginBottom: 16 },
    logoPlaceholder: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#4A3DE3', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
    ...
    categoryBadge: { backgroundColor: '#E8F5E8', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12 },
